...
const FACTORY = require("./build/GLXSwapV2Factory.json");
const PAIR = require("./build/GLXSwapV2Pair.json");
...
export async function getReserves(
  ...
  let liquidityTokens_BN;
  if( reservesRaw[0] != 0 &&  reservesRaw[1] != 0){
   liquidityTokens_BN = await pair.balanceOf(accountAddress);
  }else{
    liquidityTokens_BN = 0
  }
